    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-calendar3-event"></i> Edición de asistencias</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/attendance/editAttendance.php"); ?>
            <div class="row">
