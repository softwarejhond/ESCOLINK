    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-person-lines-fill"></i> Listado de estudiantes</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/groups/listadoEstudiantes.php"); ?>
            <div class="row">
